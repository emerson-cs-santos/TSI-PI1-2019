...
// Carrega Foto anterior em relação a atual - REUNIÒES
function anterior()
{
    // Carrega posição atual da foto
    var atual = load('trabalho');
...
// Carrega Foto seguinte em relação a atual - REUNIÒES
function proximo()
{
    // Carrega posição atual da foto
    var atual = load('trabalho');
...
// Carrega caminho da imagem pertinente a imagem - REUNIÒES
function trabalho_caminho(N_trabalho)
{
   var caminho = '';
...
// Carrega caption da label referente a imagem - REUNIÒES
function trabalho_caption(N_trabalho)
{
    var caption = '';
